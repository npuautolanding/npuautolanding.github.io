...
Training, testing dataset and demo video for Hybrid camera array based UAV Auto-Landing on Ground Moving UGV in GPS-denied Environment can be download [baidu](https://pan.baidu.com/s/1nBWrJW7TP_uv8qgx8RFZkg). [youtube](https://youtu.be/2JNWDdAnKT4). 
