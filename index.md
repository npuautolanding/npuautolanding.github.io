...
Demo video for Hybrid camera array based UAV Auto-Landing on Ground Moving UGV in GPS-denied Environment can be download [baidu](https://pan.baidu.com/s/1Wa_dFRmYHvJMmmz-vxWBag). [youtube](https://youtu.be/2JNWDdAnKT4). 
